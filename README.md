...
本次发布的是**乾坤鼎**系列和**八卦炉**系列的Beta版本，引擎仍在快速迭代中，更多的功能更新请持续关注我们的Github。
...
- `2022/12/23`：发布八卦炉引擎Beta版本，支持以110M参数的base模型为底座的分类、信息抽取类型任务

## 即将发布

- 更好的使用体验，更清晰的接口，更完善的模块划分，代码快速迭代中；
- 增加信息抽取任务，基于统一范式的信息抽取模型即将公开；
- 八卦炉引擎分类场景的高级模式，使用大模型生成数据、数据打标进一步提升base模型效果
- 八卦炉引擎NLI、句子匹配类型任务即将发布
...
- 硬件环境需求
    ...
    - 八卦炉引擎至少需要一张8G显存的RTX3060Ti，使用V100和A100能够获得更好的性能体验；
