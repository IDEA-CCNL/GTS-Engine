...
from ...lib.framework.classification_finetune import BaseTrainingArgumentsClf, BaseInferenceArgumentsClf
...
class TrainingArgumentsClfStd(BaseTrainingArgumentsClf):
    ...
    def _add_args(self, parser: GeneralParser) -> None:
        ...
        parser.add_argument("--rdrop_gate", dest="rdrop_gate", type=int, default=50, 
                            help="Determine whether to use rdrop based on the number of categories in the classification task")               
