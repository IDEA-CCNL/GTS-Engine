...
from gts_engine.bagualu.lib.utils.json_processor import load_json
...
class TokenizerGenerator:
    ...
    def generate_tokenizer(
        cls,
        pretrained_model_dir: Union[str, DirectoryPath]
    ) -> PreTrainedTokenizer:
        ...
        return (cls.__get_ernie_tokenizer(pretrained_model_dir) if
                model_config['vocab_size'] == 18000 else
